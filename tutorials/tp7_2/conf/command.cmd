...
LOG -s root.u_parallel_filter.result -c root.clk_fast -e p -b 0 -d 0 -t txt
LOG -s root.u_parallel_filter.r_reg.i -c root.clk_fast -e p -b 0 -d 0 -t txt
LOG -s root.u_parallel_filter.r_reg.o -c root.clk_fast -e p -b 0 -d 0 -t txt
LOG -s root.u_filter.i_signal -c root.clk_fast -e p -b 0 -d 0 -t txt
LOG -s root.u_filter.o_signal -c root.clk_fast -e p -b 0 -d 0 -t txt
LOG -s root.u_filter.r_shift_reg.o -c root.clk_fast -e p -b 0 -d 0 -t txt
LOG -s root.u_filter.coeffs -c root.clk_fast -e p -b 0 -d 1 -t txt
LOG -s root.u_ser_to_par.i_serial -c root.clk_fast -e p -b 0 -d 0 -t txt
LOG -s root.u_ser_to_par.o_parallel -c root.clk_fast -e p -b 0 -d 0 -t txt
