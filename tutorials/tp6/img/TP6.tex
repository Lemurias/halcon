...
\begin{frame}{TP6}
	\begin{figure}
		...
		\begin{tikzpicture}[thick,scale=0.6, every node/.style={scale=0.6}]
			...
			Generator
			\end{tabular}};
			\node[square_block, right of = symbolgenerator, node distance = 3 cm, label={u\_upsampling}] (upsampler){$\uparrow$};
			\node[block, right of = upsampler, node distance = 3.5 cm, label={u\_rrc\_filter}] (rrc_filter){\begin{tabular}{c}
			Root Raised \\
			Cosine Filter
			\end{tabular} };
			\node[node_output, right of = rrc_filter, node distance = 3 cm, label = {0:o\_signal}] (o_signal) {} ;
			
			\draw[arrows=->, >=latex] (symbolgenerator) -- (upsampler);
			\draw[arrows=->, >=latex] (upsampler) -- (rrc_filter);
			\draw[arrows=-, >=latex] (rrc_filter) -- (o_signal);

			\node[node_clock, label = {180:clk}] at ($ (symbolgenerator) - (2, 1.5) $) (i_clock){};
			\node[node_clock, below of = i_clock, node distance = 1 cm, label={180:clk\_oversampling}] (i_clock_os){};
			
			\draw[dotted, arrows=->, >=latex] (i_clock) -| (symbolgenerator);
			\draw[dotted, arrows=->, >=latex] (i_clock_os) -| (upsampler);
			\draw[dotted, arrows=->, >=latex] (i_clock_os) -| (rrc_filter);
			
			% Module
            \draw [ rounded corners,dashed,postaction={draw,line width=1pt}](i_clock_os) -- ++(0,-0.75) -| (o_signal) -- ++(0,1.5) -| (i_clock) -- (i_clock_os);
		\end{tikzpicture}
		\caption{TP6 Connection}
...
\begin{frame}{Root Raised Cosine Filter (4 bauds)}
    \begin{figure}[h!]
        \centering
        \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
                ...
                \node at (3,0) (reg_3){};
                \draw[arrows=->,>=latex] (reg_3) -| node[pos=0.99,label={0:\tiny h(14)},name=prod_3]{} ++ (0.5,-1.8);
                \node[sum, below of = prod_3, node distance = 1.5cm] (sum_3){\tiny +};
                \draw[arrows=->,>=latex] (prod_3.center) -- (sum_3);
                
                \node[reg] at (4,0) (reg_4){};
                \draw[arrows=->,>=latex] (reg_4) -| node[pos=0.99,label={0:\tiny h(15)},name=prod_4]{} ++ (0.5,-1.8);
        ...
        \end{tikzpicture}
        \caption{Root Raised Cosine Filter Module with 16 taps}
        \label{fig:lab_02}
    \end{figure}
\end{frame}
...
\begin{frame}{Root Raised Cosine Filter (6 bauds)}
    \begin{figure}[h!]
        \centering
        \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
                ...
                \node at (3,0) (reg_3){};
                \draw[arrows=->,>=latex] (reg_3) -| node[pos=0.99,label={0:\tiny h(22)},name=prod_3]{} ++ (0.5,-1.8);
                \node[sum, below of = prod_3, node distance = 1.5cm] (sum_3){\tiny +};
                \draw[arrows=->,>=latex] (prod_3.center) -- (sum_3);
                
                \node[reg] at (4,0) (reg_4){};
                \draw[arrows=->,>=latex] (reg_4) -| node[pos=0.99,label={0:\tiny h(23)},name=prod_4]{} ++ (0.5,-1.8);
                \node[sum, below of = prod_4, node distance = 1.5cm] (sum_4){\tiny +};
                \draw[arrows=->,>=latex] (prod_4.center) -- (sum_4);
        ...
        \end{tikzpicture}
        \caption{Root Raised Cosine Filter Module with 24 taps}
        \label{fig:lab_02}
    \end{figure}
\end{frame}
...
\begin{frame}{Root Raised Cosine Filter (8 bauds)}
    \begin{figure}[h!]
        \centering
        \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
                ...
                \node at (3,0) (reg_3){};
                \draw[arrows=->,>=latex] (reg_3) -| node[pos=0.99,label={0:\tiny h(30)},name=prod_3]{} ++ (0.5,-1.8);
                \node[sum, below of = prod_3, node distance = 1.5cm] (sum_3){\tiny +};
                \draw[arrows=->,>=latex] (prod_3.center) -- (sum_3);
                
                \node[reg] at (4,0) (reg_4){};
                \draw[arrows=->,>=latex] (reg_4) -| node[pos=0.99,label={0:\tiny h(31)},name=prod_4]{} ++ (0.5,-1.8);
                \node[sum, below of = prod_4, node distance = 1.5cm] (sum_4){\tiny +};
                \draw[arrows=->,>=latex] (prod_4.center) -- (sum_4);
        ...
        \end{tikzpicture}
        \caption{Root Raised Cosine Filter Module with 32 taps}
        \label{fig:lab_02}
    \end{figure}
\end{frame}
...
\begin{frame}{Root Raised Cosine Filter (10 bauds)}
    \begin{figure}[h!]
        \centering
        \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
                ...
                \node at (3,0) (reg_3){};
                \draw[arrows=->,>=latex] (reg_3) -| node[pos=0.99,label={0:\tiny h(38)},name=prod_3]{} ++ (0.5,-1.8);
                \node[sum, below of = prod_3, node distance = 1.5cm] (sum_3){\tiny +};
                \draw[arrows=->,>=latex] (prod_3.center) -- (sum_3);
                
                \node[reg] at (4,0) (reg_4){};
                \draw[arrows=->,>=latex] (reg_4) -| node[pos=0.99,label={0:\tiny h(39)},name=prod_4]{} ++ (0.5,-1.8);
                \node[sum, below of = prod_4, node distance = 1.5cm] (sum_4){\tiny +};
                \draw[arrows=->,>=latex] (prod_4.center) -- (sum_4);
        ...
        \end{tikzpicture}
        \caption{Root Raised Cosine Filter Module with 40 taps}
        \label{fig:lab_02}
    \end{figure}
\end{frame}
