...
LOG -s root.u_rc_filter.o_signal -c root.clk_oversampling -e p -b 0 -d 0 -t txt
LOG -s root.u_rc_filter.o_shift_reg -c root.clk_oversampling -e p -b 0 -d 0 -t txt
LOG -s root.u_rc_filter.coeffs -c root.clk_oversampling -e p -b 0 -d 1 -t txt